package com.miao.android.myzhihudaily.ui.view;
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attr) {
                case R.styleable.CircleImageView_borderRadius:
                    // 获取圆角大小
                    mBorderRadius = array.getDimensionPixelSize(R.styleable.CircleImageView_borderRadius,
                            (int) TypedValue.applyDimension(TypedValue
                                    .COMPLEX_UNIT_DIP, BORDER_RADIUS_DEFAULT,
                                    getResources().getDisplayMetrics()));
                    break;
                case R.styleable.CircleImageView_imageType:
                    // 获取ImageView的类型
                    type = array.getInt(R.styleable.CircleImageView_imageType, TYPE_CIRCLE);
                    break;
            }
        }
